...
BOT_TOKEN = os.getenv('BOT_TOKEN', '8528052870:AAF0cVTJxKOUG5m7ANdQrTiRGCovV3C7pRI')
...
if bot is None:
    logger.error("🚫 Bot could not be started. Check your BOT_TOKEN and API credentials.")
    # Don't exit - let the web server run for debugging
